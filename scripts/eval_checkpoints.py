...
def main():
    ...
    ap.add_argument("--test_csv", default="./eval_csvs/pbtc/pbtc_efs1y_nooptic.csv")
    ap.add_argument("--emb_dir", default="/media/sdb/divyanshu/divyanshu/genai_prognosis/pbtc_neurovfm_embeddings")
